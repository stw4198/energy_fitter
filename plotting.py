...
if pos == 'off':
	...
	plt.errorbar(energy,resolution_1,yerr=resolution_err_1,xerr=energy_err,linestyle='none',color=Tol_bright[0],label="WbLS 1% (nhits)")
	plt.errorbar(energy,resolution_3,yerr=resolution_err_3,xerr=energy_err,linestyle='none',color=Tol_bright[3],label="WbLS 3% (nhits)")
	plt.errorbar(energy,resolution_5,yerr=resolution_err_5,xerr=energy_err,linestyle='none',color=Tol_bright[7],label="WbLS 5% (nhits)")
	plt.xlim(energy[2]-0.125,energy[-1]+0.125)
	plt.ylim(0,resolution_1[2]+resolution_err_1[2]+0.05)
	plt.xlabel("Kinetic Energy [MeV]")
	plt.ylabel("Resolution [\u03C3/E]")
	...
	plt.errorbar(energy,resolution_1_q,yerr=resolution_err_1_q,xerr=energy_err,linestyle='none',color=Tol_bright[0],label="WbLS 1% (charge)")
	plt.errorbar(energy,resolution_3_q,yerr=resolution_err_3_q,xerr=energy_err,linestyle='none',color=Tol_bright[3],label="WbLS 3% (charge)")
	plt.errorbar(energy,resolution_5_q,yerr=resolution_err_5_q,xerr=energy_err,linestyle='none',color=Tol_bright[7],label="WbLS 5% (charge)")
	plt.xlim(energy[2]-0.125,energy[-1]+0.125)
	plt.ylim(0,resolution_1[2]+resolution_err_1[2]+0.05)
	plt.xlabel("Kinetic Energy [MeV]")
	plt.ylabel("Resolution [\u03C3/E]")
	...
	popt, pcov = curve_fit(fit, energy, resolution_1_q)
	
	plt.errorbar(energy,resolution_1,yerr=resolution_err_1,xerr=energy_err,linestyle='none',color=Tol_bright[3],label="WbLS 1% (nhits)")
	plt.errorbar(energy,resolution_1_q,yerr=resolution_err_1_q,xerr=energy_err,linestyle='none',color=Tol_bright[7],label="WbLS 1% (charge)")
	plt.errorbar(energy,fit(energy,*popt),color=Tol_bright[0],label='fit: %5.3f/$\sqrt{E}$ + %5.3f + %5.3f/E' % tuple(popt))
	plt.xlim(energy[2]-0.125,energy[-1]+0.125)
	plt.ylim(0,resolution_1[2]+resolution_err_1[2]+0.05)
	plt.xlabel("Kinetic Energy [MeV]")
	plt.ylabel("Resolution [\u03C3/E]")
	...
	popt, pcov = curve_fit(fit, energy, resolution_3_q)
	
	plt.errorbar(energy,resolution_3,yerr=resolution_err_3,xerr=energy_err,linestyle='none',color=Tol_bright[3],label="WbLS 3% (nhits)")
	plt.errorbar(energy,resolution_3_q,yerr=resolution_err_3_q,xerr=energy_err,linestyle='none',color=Tol_bright[7],label="WbLS 3% (charge)")
	plt.errorbar(energy,fit(energy,*popt),color=Tol_bright[0],label='fit: %5.3f/$\sqrt{E}$ + %5.3f + %5.3f/E' % tuple(popt))
	plt.xlim(energy[2]-0.125,energy[-1]+0.125)
	plt.ylim(0,resolution_1[2]+resolution_err_1[2]+0.05)
	plt.xlabel("Kinetic Energy [MeV]")
	...
	popt, pcov = curve_fit(fit, energy, resolution_5_q)

	plt.errorbar(energy,resolution_5,yerr=resolution_err_5,xerr=energy_err,linestyle='none',color=Tol_bright[3],label="WbLS 5% (nhits)")
	plt.errorbar(energy,resolution_5_q,yerr=resolution_err_5_q,xerr=energy_err,linestyle='none',color=Tol_bright[7],label="WbLS 5% (charge)")
	plt.errorbar(energy,fit(energy,*popt),color=Tol_bright[0],label='fit: %5.3f/$\sqrt{E}$ + %5.3f + %5.3f/E' % tuple(popt))
	plt.xlim(energy[2]-0.125,energy[-1]+0.125)
	plt.ylim(0,resolution_1[2]+resolution_err_1[2]+0.05)
